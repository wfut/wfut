class WFEffectModels_MISSING extends WFMeshImports;
...
#exec MESHMAP SETTEXTURE MESHMAP=geonormal NUM=1 TEXTURE=DefaultTexture
...
#exec MESHMAP SETTEXTURE MESHMAP=geoflipped NUM=1 TEXTURE=DefaultTexture
...
#exec MESHMAP SETTEXTURE MESHMAP=geotwos NUM=1 TEXTURE=DefaultTexture
...
#exec MESHMAP SETTEXTURE MESHMAP=rdubounce NUM=1 TEXTURE=DefaultTexture
...
#exec MESHMAP SETTEXTURE MESHMAP=torusanim NUM=1 TEXTURE=DefaultTexture
...
#exec MESHMAP SETTEXTURE MESHMAP=toruseff NUM=1 TEXTURE=DefaultTexture
...
#exec MESHMAP SETTEXTURE MESHMAP=toruseff1 NUM=1 TEXTURE=DefaultTexture
...
#exec MESHMAP SETTEXTURE MESHMAP=toruseff2 NUM=1 TEXTURE=DefaultTexture
