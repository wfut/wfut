class WFUBrowserModFact extends UBrowserGSpyFact;
...
function Query(optional bool bBySuperset, optional bool bInitial)
{
	...
	Link = GetPlayerOwner().GetEntryLevel().Spawn(class'WFUBrowserModLink');
	WFUBrowserModLink(Link).GameType = GameType;
