class WFTeslaStarterBolt extends WFTeslaBolt;
...
{
     StartError=0.500000
     SpriteAnim(0)=Texture'TeslaStarterBolt0'
     SpriteAnim(1)=Texture'TeslaStarterBolt1'
     SpriteAnim(2)=Texture'TeslaStarterBolt2'
     SpriteAnim(3)=Texture'TeslaStarterBolt3'
     SpriteAnim(4)=Texture'TeslaStarterBolt4'
  	 Skin=Texture'TeslaStarterBolt0'
  	 Texture=Texture'TeslaStarterBolt0'
